        ...
        <div className="flex item-center justify-between  flex-col lg:flex-row">
          ...
          <div className="xl:w-[670px]">
            ...
            <ul className="pl-4">
              ...
              <li className="text__para">
                3. View our physician who are accepting new patients, ust the
          ...
          <div className="relative z-10 xl:w-[770px] flex justify-end mt-[50px] lg:mt-0 ">
            ...
            <div className="w-[150px]  lg:w-[248px] bg-white absolute bottom-[50px] left-0 md:bottom-[100px] md:left-5 z-20 p-2 pb-3 lg:pt-4 lg:px-4 lg:pb-[26px] rounded-[10px] ">
              ...
              <div className="w-[65px] lg:w-[96px] bg-[#CCF0F3] py-1 px-2 lg:py-[6px] lg:px-[10px] text-[8px] leading-[8px] lg:text-[12px] lg:leading-4  text-irisBlueColor font-[900] mr-2 lg:mt-4 rounded-full ">
                Consultation
              </div>
        ...
        <div className='container'>
             <div className="flex justify-between gap-[50px] lg:gap-0">
              ...
              <div className='w-full md:w-1/2' >
                  <h1 className='heading' >Most questions by our beloved patients</h1>
                  <FaqList/>
              </div>
             </div>
        </div>
